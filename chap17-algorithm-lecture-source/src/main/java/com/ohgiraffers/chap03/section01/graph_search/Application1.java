 ...
 *   한쪽 분기를 정하여 최대 깊이까지 탐색을 마친 후 다른쪽 분기로 이동하여
 *   다시 탐색을 수행하는 알고리즘이다.
* */
...
public class Application1 {
    ...
    public static Integer solution(String input) throws IOException {
        ...
        /* 설명. 방문 배열을 작성(방문 배열을 작성하는 이유는 방문했던 노드를 다시 stack에 담지 않거나 다시 재귀 함수 호출을 하지 않기 위함) */
        visit = new boolean[node + 1];              // 방문 배열도 노드 번호와 인덱스 번호를 일치 시키기 위해서 1증가
...
//            map[b][a] = 1;
        ...
        /* 설명. dfs 그래프 탐색 기법으로 1번 노드부터 1번 노드와 관련된 모든 노드들을 카운팅 하는 메소드 호출 */
        dfs(1);
    ...
    public static void dfs(int start) {
        ...
        /* 설명. 넘어온 노드와 연관된 노드를찾는 반복문(기존에 방문하지 않았던) */
