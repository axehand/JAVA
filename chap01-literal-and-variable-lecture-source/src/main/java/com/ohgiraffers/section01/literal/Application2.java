...
//        System.out.println(579);
        ...
        System.out.println(123 / 10);
        System.out.println(123 % 10);       // 필기. modulus 연산자(mod 연산자): 제수로 나눈 나머지
        ...
        System.out.println(1.23 / 10.0);
        System.out.println(1.23 % 1.0); // 필기. 실수는 정확하지 않고 근삿값
        ...
        System.out.println("hello" + "world");      // 필기. 문자열간의 연산은 덧셈(이어붙이기)만 가능하다.
