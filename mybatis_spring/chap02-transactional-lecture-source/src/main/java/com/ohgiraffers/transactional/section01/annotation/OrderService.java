...
public class OrderService {
    ...
    /* 설명.
     *  OrderDTO에 담겨 있을 내용
     *  : Service계층부터 개발할 떄는 사용자가 입력한 값들이 어떻게 DTO 또는 Map으로 묶여서
     *  Service로 넘어올 지 충분히 고민한 후 매개변수를 작성하고 개발한다.
     *  현재의 경우 사용자가 고른 메뉴들 각각의 코드 번호와 고른 메뉴 갯수, 그리고 서버의 현재시간이
...
//        System.out.println("menuCode : " + menuCode);
        ...
        /* 설명. 2. 주문한 메뉴 별로 Menu엔티티에 담아서 조회해 오기(부가적인 메뉴의 정보 추출) */
...
//        );
        ...
        /* 설명. 5. tbl_order_menu에도 주문한 메뉴 갯수만큼 추가(insert)한다. */
