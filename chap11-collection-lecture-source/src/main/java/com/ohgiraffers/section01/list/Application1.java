...
//        ArrayList<Object> aList = new ArrayList<Object>();        // 다이아몬드 연산자 없는 제네릭 클래스는 <Object>와 같다
...
//        Collection col = new ArrayList();
        ...
        * */
        ...
        /* 설명 set() 메소드로 원하는 인덱스의 값을 원하는값으로 수정할 수 있다. */
        aList.set(1,777);
        System.out.println(aList);

        /* 설명. remove() 메소드로 원하는 인덱스의 값을 삭제가능 */
        aList.remove(1);
        System.out.println(aList);
        ...
        stringList = new LinkedList<>(stringList);          //다형성을 이용해서 List인 stringList에 동적바인딩으로 LinkedList를 넣어줌
        Iterator<String> iter = ((LinkedList<String>)stringList).descendingIterator();//다운캐스팅을 이용해서 stringList가 LinkedList의 기능을 사용 할 수 있게 만들어줌
        while(iter.hasNext()){
