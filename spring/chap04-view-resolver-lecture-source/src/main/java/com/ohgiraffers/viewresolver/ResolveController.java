...
public class ResolveController {
    ...
    public ModelAndView modelAndViewRedirect(ModelAndView mv){
        ...
        /* 설명. ModelAndView를 통한 리다이렉트 시에는 addObject 한 것이 parameter로 넘어간다.(이처럼 ?표가 있는 쿼리스트링형태로 넘어간다.) */
        mv.addObject("message2", "ModelAndView를 이용한 redirect");
        mv.setViewName("redirect:/");
//        mv.setViewName("redirect:/?message2=ModelAndView를 이용한 redirect"); 이처럼 ?표가 있는 쿼리스트링형태로 넘어간다.
