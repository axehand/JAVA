...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("태어난 일 : " + (birthDay.get(5) + 1));     //get() 메소드로 반환받은 값에 +1을 해줘야 우리가 생각하는 일의 개념이 된다.
        System.out.println("태어난 해 : " + (birthDay.get(Calendar.DAY_OF_MONTH)+1));
        ...
        String birthDayString = sdf.format(birthDay.getTimeInMillis());
